...
# node ./data/import.js && node ./data/import_restaurants.js && node ./data/import_amenities.js && node ./data/import_gas_types.js && node ./data/import_location_restaurants.js && node ./data/import_location_gas_types.js && node ./data/import_location_amenities.js
# import json data directly to speed up load time 
node ./data/site_seed.js;
echo $?